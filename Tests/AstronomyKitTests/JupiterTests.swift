...
struct JupiterTests {
    ...
    func testAppearance() {
        ...
        AssertEqual(jupiter.geometricCentralMeridianLongitudeSystemI, Degree(267.63), accuracy: Degree(0.1))
        AssertEqual(jupiter.geometricCentralMeridianLongitudeSystemII, Degree(72.31), accuracy: Degree(0.1))
        AssertEqual(jupiter.apparentCentralMeridianLongitudeSystemI, Degree(268.06), accuracy: Degree(0.1))
        AssertEqual(jupiter.apparentCentralMeridianLongitudeSystemII, Degree(72.74), accuracy: Degree(0.1))
    }
}
