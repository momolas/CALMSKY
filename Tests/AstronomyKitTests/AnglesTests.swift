...
struct AnglesTests {
    ...
    func testDegreeMinusSignConstructor() {
        #expect(Degree(.minus, 1, 7, 30.0).value == -1.125)
        #expect(Degree(.minus, -1, 7, 30.0).value == -1.125)
        #expect(Degree(.minus, 1, -7, 30.0).value == -1.125)
        #expect(Degree(.minus, 1, 7, -30.0).value == -1.125)
        #expect(Degree(.minus, -1, -7, 30.0).value == -1.125)
    ...
    func testDegreePlusSignConstructor() {
        #expect(Degree(.plus, 1, 7, 30.0).value == 1.125)
        #expect(Degree(.plus, -1, 7, 30.0).value == 1.125)
        #expect(Degree(.plus, 1, -7, 30.0).value == 1.125)
        #expect(Degree(.plus, 1, 7, -30.0).value == 1.125)
        #expect(Degree(.plus, -1, -7, 30.0).value == 1.125)
    ...
    func testDegreeMinusZeroSignConstructor() {
        #expect(Degree(.minus, 0, 7, 30.0).value == -0.125)
        #expect(Degree(.minus, 0, -7, 30.0).value == -0.125)
        #expect(Degree(.minus, 0, 7, -30.0).value == -0.125)
        #expect(Degree(.minus, 0, -7, -30.0).value == -0.125)
        #expect(Degree(.minus, 0, 0, 90.0).value == -0.025)
        #expect(Degree(.minus, 0, 0, -90.0).value == -0.025)
    }
    
    @Test("Degree Plus Zero Sign Constructor")
    func testDegreePlusZeroSignConstructor() {
        #expect(Degree(.plus, 0, 7, 30.0).value == 0.125)
        #expect(Degree(.plus, 0, -7, 30.0).value == 0.125)
        #expect(Degree(.plus, 0, 7, -30.0).value == 0.125)
        #expect(Degree(.plus, 0, -7, -30.0).value == 0.125)
        #expect(Degree(.plus, 0, 0, 90.0).value == 0.025)
        #expect(Degree(.plus, 0, 0, -90.0).value == 0.025)
    }
