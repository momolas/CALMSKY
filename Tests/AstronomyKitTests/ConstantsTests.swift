...
class ConstantsTests: XCTestCase {
    ...
    func testPlanet2PlanetaryObjectType() {
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetMercury).objectType! is AstronomyKit.Mercury.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetVenus).objectType! is AstronomyKit.Venus.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetEarth).objectType == nil)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetMars).objectType! is AstronomyKit.Mars.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetJupiter).objectType! is AstronomyKit.Jupiter.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetSaturn).objectType! is AstronomyKit.Saturn.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetNeptune).objectType! is AstronomyKit.Neptune.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetUranus).objectType! is AstronomyKit.Uranus.Type)
